        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-center select-none w-full">
            ...
            >
              ...
              <div className="bg-zinc-900 border-b border-zinc-850 px-4 py-2 flex items-center gap-4">
              ...
              <div className="p-5 sm:p-7 bg-zinc-950 text-zinc-350 min-h-[300px] flex flex-col justify-between text-left rounded-b-[22px]">
                {/* Hero header */}
                <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 py-6">
                  <div className="p-3 bg-zinc-900 border border-zinc-850 rounded-xl shadow-xs">
                    <h4 className="text-[9px] font-black text-white">Developer Portfolio Host</h4>
                    <p className="text-[8px] text-zinc-400 mt-1 leading-normal">
                      Dynamic React builder compiling resume profiles to CDN DNS targets.
                    </p>
                  </div>
                  <div className="p-3 bg-zinc-900 border border-zinc-850 rounded-xl shadow-xs">
                    <h4 className="text-[9px] font-black text-white">Checkout Optimizations</h4>
                    <p className="text-[8px] text-zinc-400 mt-1 leading-normal">
                ...
                {/* Footer branding */}
                <div className="pt-3 border-t border-zinc-900 flex justify-between text-[7px] text-zinc-500 uppercase font-bold tracking-wider">
