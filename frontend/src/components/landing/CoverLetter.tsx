          ...
          <div className="lg:col-span-5 text-left order-first">
            ...
            <ScrollReveal variant="fade-up" delay={200} className="space-y-4 bg-zinc-900 border border-zinc-800 p-6 rounded-3xl">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] font-bold uppercase tracking-wider text-zinc-500 block">Company</label>
                  <input
                    type="text"
                    value={company}
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold uppercase tracking-wider text-zinc-500 block">Tone of Voice</label>
